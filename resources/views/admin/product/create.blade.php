...
<div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Product Color 1: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="product_color1" id="color"  >
                </div>
              </div><!-- col-4 -->

<div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Product Color 2: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="product_color2" id="color"  >
                </div>
              </div><!-- col-4 -->

<div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Product Color 3: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="product_color3" id="color"  >
                </div>
              </div><!-- col-4 -->
            ...
            <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" data-placeholder="Choose country" name="package">
